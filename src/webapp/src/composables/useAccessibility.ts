...
export function useFocusTrap(containerRef: { value: HTMLElement | null }, options: FocusTrapOptions = {}) {
  const { initialFocus = null, returnFocusOnDeactivate = true, allowOutsideClick = false } = options
